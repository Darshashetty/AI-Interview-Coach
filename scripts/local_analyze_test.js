// local_analyze_test.js
// Mirrors /api/analyze heuristics and computeScoring to produce a JSON output for testing
const transcript = "This is a test transcript to exercise heuristics. I said um and like a couple times.";
const duration = 30;
...
const result = analyze(transcript, duration);
